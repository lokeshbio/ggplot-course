...
Now we can specify what we want on the x and y axes using aethetic mapping. And we specify the geometric using `geoms`. <i class="fas fa-exclamation-circle"></i> Note &nbsp; that the variable names do not have double quotes `""` like in base plots.
