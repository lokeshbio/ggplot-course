...
**Before starting with the lab sessions of the entire course, you must have downloaded all the necessary files from [here](lab_download.html) and made sure that the directory tree looks similar to the one displayed in that page**
