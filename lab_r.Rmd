...
In terms of the R (and other similar progamming languages), the data can be viewed or stored in two main formats! They are called `wide` and `long` formats. Below you will see what exactly they stand for and why is it important for plottong in ggplot.
...
* However, adding data to wide format data sets is very hard:
  1. It is very difficult to conceive of analytical schemes that apply generally across all wide-format data sets.
