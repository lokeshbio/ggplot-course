...
In this chapter, we will mainly focus on making a "publication-type" figure, with sub-plots and such using different tools in R. There are many different ways/packages to do this, but we will mainly focus on 3 packages: `cowplot`, `ggpubr` and `ggarrange`.
