...
## Combining and annotating

In this part of the lab, we will look into: how one can combine different plots that we have made and at the same time annotate these plots.

[<i class="fas fa-link"></i> <span class="large">Combining and annotating</span>](lab_gg_4.html)
