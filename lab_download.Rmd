...
* GPS readings from a [bike ride](data/ggmap_data/bike-ride.csv)
* A dataset of fish sampling [locations](data/ggmap_data/bc_sites.rds)

*Acknowledgement: The map-data in this course are obtained from Eric. C. Anderson's [GitHub page](https://github.com/eriqande)*
