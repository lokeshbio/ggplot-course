...
.pull-center[
<img src="images/inst_check.png" alt="drawing" width="500"/>
]
...
--
.pull-center[
<img src="images/free.png" alt="drawing" width="300"/>
]
...
```{r, echo=FALSE}
gc <- read.table("data/count_raw.txt", header = T, row.names = 1, sep = "\t")
...
.pull-center[
<img src="images/df.png" alt="drawing" width="600"/>
]
